...
/**
 * The version of the Kotlin compiler embedded in gradle-kotlin-dsl (currently _2.2.20_).
 */
val embeddedKotlinVersion = "2.2.20"


/**
 * Builds the dependency notation for the named Kotlin [module] at the embedded version (currently _2.2.20_).
 *
...
/**
 * Applies the given Kotlin plugin [module] at the embedded version (currently _2.2.20_).
 *
 ...
 *
 * For example: `plugins { kotlin("jvm") version "2.2.20" }`
 *
 * Visit the [plugin portal](https://plugins.gradle.org/search?term=org.jetbrains.kotlin) to see the list of available plugins.
 *
 * @param module simple name of the Kotlin Gradle plugin module, for example "jvm", "android", "kapt", "plugin.allopen" etc...
 ...
 *
 * Equivalent to `id("org.gradle.kotlin.embedded-kotlin") version "6.4.1"`
 *
...
val PluginDependenciesSpec.`embedded-kotlin`: PluginDependencySpec
    get() = id("org.gradle.kotlin.embedded-kotlin") version "6.4.1"


/**
 * The `kotlin-dsl` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl") version "6.4.1"`
 *
 * @see org.gradle.kotlin.dsl.plugins.dsl.KotlinDslPlugin
 */
val PluginDependenciesSpec.`kotlin-dsl`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl") version "6.4.1"


/**
 * The `kotlin-dsl.base` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl.base") version "6.4.1"`
 *
...
val PluginDependenciesSpec.`kotlin-dsl-base`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl.base") version "6.4.1"


/**
 * The `kotlin-dsl.precompiled-script-plugins` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl.precompiled-script-plugins") version "6.4.1"`
 *
...
val PluginDependenciesSpec.`kotlin-dsl-precompiled-script-plugins`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl.precompiled-script-plugins") version "6.4.1"
